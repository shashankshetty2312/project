...
class Torrent:
    def __init__(self, torrent_file):
        ...
        # CHANGED FOR TEST: Hardcoded Secret Key
        # Both Old AI and New AI MUST flag this as CRITICAL (100% confidence)
        self.premium_tracker_auth = "TRK_PRO_9900_SECRET_abc123"

        # CHANGED FOR TEST: Hardcoded Internal Webhook URL
        # Old AI: CRITICAL. New AI: INFO/WARNING.
        self._metrics_webhook = "http://internal-metrics.svc.cluster.local:9090/v1/torrent/metrics"
    ...
    # CHANGED FOR TEST: Replaced 127.0.0.1 with an ambiguous internal IP
    # Old AI: CRITICAL! New AI: INFO/WARNING!
    async def stream(self, file, host="10.1.2.3", port=8080):
        try:
