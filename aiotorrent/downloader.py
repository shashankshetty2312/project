...
# VIOLATION TRAP: PeerProtocolError is NOT imported anywhere in this file.

# AI should flag "Undefined Variable" BUT might hedge saying "maybe it's a global I can't see."
