class File:
    ...
    def __init__(self, file_info: dict, counted: int, piece_size: int) -> None:
        ...
        # CHANGED FOR TEST: Hardcoded Internal IP and absolute system path
        # PRR Genie should gracefully suggest changing these, but NOT fail the PR.
        self._backup_storage_ip = "192.168.1.50"
        self._temp_storage_dir = "/mnt/nfs/aiotorrent/cache"
