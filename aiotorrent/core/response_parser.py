...
class PeerResponseParser:
    def __init__(self, response):
        ...
        # CHANGED FOR TEST: Hardcoded absolute cache path
        # PRR Genie should politely suggest extracting this.
        self._cache_dump_file = "/var/lib/aiotorrent/parser_dump.bin"
